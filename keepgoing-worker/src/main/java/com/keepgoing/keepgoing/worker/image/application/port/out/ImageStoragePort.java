...
public interface ImageStoragePort {
	...
	/**
	 * 정제된 이미지를 secure bucket에 저장한다.
	 *
	 * @param storageKey secure bucket에 저장할 object key
	 * @param bytes 정제된 이미지 bytes
	 * @param contentType 정제된 이미지 Content-Type
	 * @throws ImageStorageException storage 저장 실패 시
	 */
	void putSecureObject(String storageKey, byte[] bytes, String contentType);
}
